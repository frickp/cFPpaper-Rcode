...
boxplot(l2 ~ Time.day, data=D.CHX500, notch=TRUE, xlab="Time in drug(d)", ylab="Colony Doublings", 
		border='grey20')
...
lines(1:4, mean.ctrl,col='black',lty=2,lwd=2)
#Green: prol: 0.0335; qui: 0.0211; die: 0.0166 
#Red:   prol: 0.0052; qui: 0;      die: 0
#Blue:  
